...
func (fake *MessageHandler) HandleMessage(arg1 *bolt.Tx, arg2 *sarama.ConsumerMessage) error {
...
func (fake *MessageHandler) HandleMessageCallCount() int {
	fake.handleMessageMutex.RLock()
	defer fake.handleMessageMutex.RUnlock()
	return len(fake.handleMessageArgsForCall)
}

func (fake *MessageHandler) HandleMessageCalls(stub func(*bolt.Tx, *sarama.ConsumerMessage) error) {
	fake.handleMessageMutex.Lock()
	defer fake.handleMessageMutex.Unlock()
	fake.HandleMessageStub = stub
}

func (fake *MessageHandler) HandleMessageArgsForCall(i int) (*bolt.Tx, *sarama.ConsumerMessage) {
	fake.handleMessageMutex.RLock()
	defer fake.handleMessageMutex.RUnlock()
...
func (fake *MessageHandler) HandleMessageReturns(result1 error) {
	fake.handleMessageMutex.Lock()
	defer fake.handleMessageMutex.Unlock()
...
func (fake *MessageHandler) HandleMessageReturnsOnCall(i int, result1 error) {
	fake.handleMessageMutex.Lock()
	defer fake.handleMessageMutex.Unlock()
	fake.HandleMessageStub = nil
